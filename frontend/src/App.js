...
import Delete_Info_User from './pages/User/User_Mypage/Delete_Info_User';
  ...
  return (
    <div>
      <Routes>
        ...
        <Route path="/auth/user/mypage/confirm.pw" element={<Edit_Info_User />} />
        <Route path="/auth/user/mypage/delete/userinfo" element={<Delete_Info_User />} />
